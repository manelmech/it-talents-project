          ...
          children: <Widget>[
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage('https://mdfive.dz/ecole/wp-content/uploads/2020/12/background-scaled.jpg'),
                  fit: BoxFit.cover
                ),
              ),
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    FadeAnimation(1, Text("Révélez vos competences", textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontSize: 40, fontWeight: FontWeight.bold),)),
                    SizedBox(height: 30,),
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                  FadeAnimation(1, Text("Catégories", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.grey[800], fontSize: 20),)),
                  SizedBox(height: 20,),
